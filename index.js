(function(define){
    define([], function(){
        ...
        // Large portions of this work were done by the underscore.Deferred team;
        // underscore.deferred (https://github.com/wookiehangover/underscore.Deferred)
        // is basically the same library but intended for use with underscore.js
        var breaker = {},
        AP = Array.prototype,
        OP = Object.prototype,
                    ...
                    return Deferred(function( newDefer ) {
                        ...
                        _each( tuples, function( tuple, i ) {
                            ...
                            deferred[ tuple[1] ]( _isFunction( fn ) ?
                                ...
                                } else if ( returned && _isFunction( returned.then ) ) {
                                    // Add a hack to handle thennables
        ...
        var when = function( subordinate /* , ..., subordinateN */ ) {
            ...
            if ( length > 1 ) {
                ...
                for ( ; i < length; i++ ) {
                    ...
                    } else if ( resolveValues[ i ] && _isFunction( resolveValues[ i ].then ) ) {
                        // Hack in support for thennables
                        resolveValues[ i ].then(updateFunc( i, resolveContexts, resolveValues ), deferred.reject );
                    } else {
                        --remaining;
                    }
                }
